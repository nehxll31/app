...
import GoogleButton from '../components/GoogleButton';  // Ensure correct path
import Divider from '../components/Divider';  // Ensure correct path
import { colors } from '../utils/colors';  // Ensure correct path
